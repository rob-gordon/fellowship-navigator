#!/usr/bin/env node
"use strict";var C=Object.create;var x=Object.defineProperty;var P=Object.getOwnPropertyDescriptor;var $=Object.getOwnPropertyNames;var N=Object.getPrototypeOf,F=Object.prototype.hasOwnProperty;var G=(e,t)=>{for(var i in t)x(e,i,{get:t[i],enumerable:!0})},I=(e,t,i,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of $(t))!F.call(e,n)&&n!==i&&x(e,n,{get:()=>t[n],enumerable:!(o=P(t,n))||o.enumerable});return e};var v=(e,t,i)=>(i=e!=null?C(N(e)):{},I(t||!e||!e.__esModule?x(i,"default",{value:e,enumerable:!0}):i,e)),L=e=>I(x({},"__esModule",{value:!0}),e);var Q={};G(Q,{presentOptions:()=>O});module.exports=L(Q);var s=require("@clack/prompts"),A=require("@openrouter/ai-sdk-provider"),m=require("ai"),f=require("zod"),R=v(require("fs"),1),S=v(require("path"),1),j=v(require("dotenv"),1);var H="https://offers-and-asks-slack-nbgim.ondigitalocean.app/api/extended-search",D="6fd53d2d-cd2f-49a3-ad9b-f85c867bb955";async function T(e){try{let t=await fetch(H,{method:"POST",headers:{Authorization:`Bearer ${D}`,"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok)throw new Error(`HTTP error! status: ${t.status}, statusText: ${t.statusText}`);return await t.json()}catch(t){throw console.error("\u274C Error searching fellowship content:",t),t}}j.default.config({quiet:!0});var M=process.env.OPENROUTER_API_KEY||"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",y=(0,A.createOpenRouter)({apiKey:M}),_=0,w={HAIR_ON_FIRE_PROBLEM:"",EPISTEMIC_GOAL:"",TARGET_USER:"",TECHNICAL_SHAPE:"",SIGNAL_GATHERING:""},h=Object.keys(w);async function U(){(0,s.intro)("\u{1F3AF} Welcome to the AI+Epistemics Fellowship Project Picker!");let e=process.argv[2],t=e?await B(e):"";e||s.log.info("\u{1F4A1} Tip: You can provide initial context by passing a file (npx github:rob-gordon/fellowship-navigator context.txt)");let i=await Y(t),o=!0,n=!0;for(;h.filter(g=>!w[g]).length!==0;){n?(_=await z(t),n=!1):_=o?q():W();let a=h[_],c=await K(a,t,i,w),l=(0,s.spinner)();l.start("\u{1F4AD} Thinking about options...");let d="",r="",u=null;try{r=await X(a,t,c.response,w),u=await T({query:r,topK:15,includeThreads:!0,useAdvancedRetrieval:!0,enableContextExpansion:!0,enableRecencyBoost:!1,includeDocumentSummaries:!0,sources:["slack","document"],rerank:!0,semanticWeight:.7}),d=await Z(u,a,t,c.response)}catch{d=""}finally{l.stop()}let b=!1;o=!0;let E,k;for(;o&&!b;){let g=await O(a,t,i,c.question,c.response,E,k,d);g.type==="change_options"?(E=g.previousOptions||[],k=g.explanation,b=!1,o=!0):g.type==="change_dimension"?(b=!1,o=!1):g.type==="selected"&&(w[a]=g.selected_options.join(", "),E=g.shownOptions,b=!0,o=!0),g.type}}await J(t,i,w)}async function B(e){try{let t=S.default.resolve(e);return R.default.readFileSync(t,"utf-8").trim()}catch{process.exit(1)}}async function Y(e){let t="",i=(0,m.streamText)({model:y("openai/gpt-4o-mini"),messages:[{role:"system",content:`You are an assistant helping participants in the AI+Epistemics Fellowship discover concrete project ideas.
...
You help participants through roadmapping, prototyping, and evaluation phases leading to a 12-week demo day.`},{role:"system",content:`Write a warm, brief greeting (about one paragraph) that acknowledges their interests and context. Simply welcome them to the process of exploring fellowship project ideas - don't suggest any specific project ideas yet or go into detail about what they'll discover. Keep it conversational and encouraging. Do not ask them any follow up questions.
        ...
        User context: ${e}`}],onFinish:o=>{t=o.text}});return await s.stream.message(i.textStream),t}function q(){let e=_,t=0;do if(e=(e+1)%h.length,t++,t>=h.length)return _;while(w[h[e]]);return e}function W(){let e=(_+Math.floor(h.length/2))%h.length,t=0;for(;w[h[e]]&&t<h.length;)e=(e+1)%h.length,t++;return t>=h.length?_:e}async function z(e){let{text:t}=await(0,m.generateText)({model:y("openai/gpt-4o-mini"),messages:[{role:"system",content:`You are analyzing user context to determine which project dimension they seem most interested in discussing first. 
...
Return only the dimension name exactly as it appears in the list (e.g., "TARGET_USER", "EPISTEMIC_GOAL", etc.).`}]}),i=t.trim().toUpperCase(),o=h.findIndex(n=>n===i);return o!==-1?o:h.findIndex(n=>n==="HAIR_ON_FIRE_PROBLEM")}async function K(e,t,i,o){let n=Object.keys(o).filter(r=>o[r]!==""),p="";n.length>0&&(p=`The user has already expressed preferences for the following project dimensions:
${n.map(r=>`${r}
======
${o[r]}`).join(`
...
Return only the search term, nothing else.`}]});return c.trim()}async function Z(e,t,i,o){if(!e.ok||e.slack_contexts.length===0&&e.document_contexts.length===0)return"No relevant fellowship discussions found to inform options.";let n=`Search Results for "${e.query}":
...
\u{1F4A1} **Pro tip:** Remember that your working hypothesis is meant to be tested and refined - start with the simplest version that lets you learn whether you're on the right track.`),(0,s.outro)("Ready to turn your hypothesis into reality! \u{1F30D}\u{1F52C}"),process.exit(0)}require.main===module&&U();0&&(module.exports={presentOptions});
